...
class Address_List extends \WP_List_Table {
    ...
    public function column_name( $item ){
        ...
        $actions['delete'] = sprintf( '<a href="%s" class"submitdelete" onclick="return confirm(\'Are you sure?\');" title="%s">%s</a>', wp_nonce_url( admin_url('admin-post.php?action=mr9-delete-address&id=' . $item->id ), 'mr-9-delete-address' ), $item->id, __('Delete', 'mr-9') );
